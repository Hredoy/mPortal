    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('videos.update',$video->id) }}" accept-charset="UTF-8" role="form" enctype="multipart/form-data" class="needs-validation" file="true">
                        @csrf
                        @method('PUT')
                        <div class="form-group has-feedback row"><label for="Video Title" class="col-md-3 control-label">Video Title</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input id="name" placeholder="Video Name" name="name" type="text" class="form-control" value="{{ old('name', $video->name) }}"></div>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group has-feedback row"><label for="last_name" class="col-md-3 control-label">Thumbnail Image</label>
                            <div class="col-md-9">
                                ...
                                @endif
                                <div class="col-md-9">
                                    <img src="{{ asset('/video-audio/'.Auth::user()->name.'/images/'.$video->thumbnail_image) }}" class="msg-photo" alt="" style="width: 150px; height:100px;" />
                                </div>
                            </div>
                        ...
                        <div class="form-group has-feedback row"><label for="role" class="col-md-3 control-label">Category</label>
                            <div class="col-md-9">
                                <div class="input-group"><select name="category_id" id="category_id" class="custom-select form-control">
                                        ...
                                        <option value="{{$cate->id}}" {{ $cate->id == $video->category_id ? 'selected':''}}>{{$cate->category_name}}</option>
                                        @endforeach
                                    </select></div>
                        ...
                        <div class="form-group has-feedback row"><label for="Video Title" class="col-md-3 control-label">Relese Date</label>
                            <div class="col-md-5">
                                <div class="input-group">
                                    <input id="" placeholder="Release Date" name="release_date" type="date" class="form-control" value="{{ old('release_date', $video->release_date) }}"></div>
                        ...
                        <div class="form-group has-feedback row"><label for="role" class="col-md-3 control-label">Region</label>
                            <div class="col-md-5">
                                <div class="input-group"><select name="region_id" id="region_id" class="custom-select form-control">
                                        ...
                                        @foreach ($country as $ctn)
                                        <option value="{{$ctn->id}}" {{ $ctn->id == $video->region_id ? 'selected':''}}>{{$ctn->iso3}} || {{ $ctn->nicename }}</option>
                                        @endforeach
                                    </select></div>
                        ...
                        <div class="form-group has-feedback row"><label for="Video Title" class="col-md-3 control-label">Video/Audio Duration</label>
                            <div class="col-md-5">
                                <div class="input-group">
                                    <input id="" placeholder="Video/Audio Duration" name="video_duration" type="time" class="form-control" value="{{ old('video_duration', $video->video_duration) }}"></div>
