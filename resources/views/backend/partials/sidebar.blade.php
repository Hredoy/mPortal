    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ Request::is('category*')? 'active active-menu' : null }}">
                    <a href="#category" class="iq-waves-effect collapsed" data-toggle="collapse"
                        aria-expanded="{{ Request::is('category*')? 'true' : 'false' }}"><i class="las la-list-ul"></i><span>Category</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="category" class="iq-submenu collapse {{ Request::is('category*')? 'show' : null }}" data-parent="#iq-sidebar-toggle">
                        <li class="{{ Request::is('category/create')? 'active' : null }}"><a href="{{Route('categories.create')}}"><i class="las la-user-plus"></i>Add Category</a></li>
                        <li class="{{ Request::is('category')? 'active' : null }}"><a href="{{Route('categories')}}"><i class="las la-eye"></i>Category List</a></li>
                    </ul>
                </li>
                @endrole
