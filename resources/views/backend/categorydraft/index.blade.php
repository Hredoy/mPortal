                    ...
                    <div class="table-responsive videos-table">
                        <table class="table table-striped table-sm data-table">
                            <caption id="video_count">
                                {{ trans_choice('videosmanagement.videos-table.caption', 1, ['videoscount' => $categories->count()]) }}
                            </caption>
                            <thead class="thead">
                                <tr>
                                    <th>{!! trans('SL') !!}</th>
                            ...
                            <tbody id="videos_table">
                                ...
                                <tr>
                                    ...
                                    <td>{{$category->name}}</td>
                                    <td class="hidden-xs">{{$category->category_name}}</td>
                                    <td class="hidden-xs">
                                    ...
                                    <td><a href="{{route('categories.edit',$category->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-outline-secondary btn-block"><span class="hidden-xs hidden-sm">Edit </span></a>
...
@if ((count($categories) > config('videosmanagement.datatablesJsStartCount')) && config('videosmanagement.enabledDatatablesJs'))
