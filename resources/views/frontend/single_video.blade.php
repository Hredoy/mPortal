...
muted autoplay @endguest>
                            ...
                            @else
                                <a href=""><img src="{{ asset($upload->thumbnail_image) }}" alt=""
                                        width="auto" height="350px" class="ls_obj-cover"></a>
                            @endif
                            {{-- For Next Link --}}
                    ...
                    <div class="info">
                        ...
                        <div class="comments-list" id="commentList">
                            @foreach ($upload->comments as $comment)
                                <!-- comment -->
                                <div class="cl-comment" id="comment{{ $comment->id }}">
                                    <div class="cl-avatar"><a href="#"><img style=" height: 62;width: 70px;"
                                                src="{{ asset($comment->image) }}"></a></div>
                                    <div class="cl-comment-text">
                                        <div class="cl-name-date"><a href="#">{{ $comment->user->name }}</a> .
                                        ...
                                        @if ($comment->user->id == Auth::id())
                                            <span class="btn btn-sm pull-right comment-del"
                                                id="{{ $comment->id }}"><i class="fa fa-minus-circle text-danger"
                                                    style="font-size: 1.2em"></i></span>
                                        @endif
                                        @if (count($comment->replies) > 0)
                                            <div class="cl-replies"><a data-toggle="collapse"
                                        ...
                                        @endif
                                        <div class="cl-flag"><a href="#"><i class="cv cvicon-cv-flag"></i></a>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
