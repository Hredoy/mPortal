    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2">
                <!-- Small button group -->
                <div>
                    <a href="#"><img src="{{ asset('assets/frontend/images/facebook.svg') }}" alt="facebook"></a>
                    <a href="#"><img src="{{ asset('assets/frontend/images/twitter.svg') }}" alt="facebook"></a>
                    <a href="#"><img src="{{ asset('assets/frontend/images/instagram.svg') }}" alt="facebook"></a>
                    <a href="#"><img src="{{ asset('assets/frontend/images/youtube.svg') }}" alt="facebook"></a>
                </div>
            </div>
        </div>
    </div>
