                ...
                <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item <?php echo e(Request::is('blocker') ? 'active' : null); ?>" href="<?php echo e(url('/category')); ?>">
...
<?php /**PATH C:\xampp\htdocs\projects\pro-4\mPortal\resources\views/partials/nav.blade.php ENDPATH**/ ?>