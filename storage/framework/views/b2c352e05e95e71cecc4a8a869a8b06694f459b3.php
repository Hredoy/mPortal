    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('videos.store')); ?>" accept-charset="UTF-8" role="form" enctype="multipart/form-data" class="needs-validation" file="true">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group has-feedback row"><label for="role" class="col-md-3 control-label">Region</label>
                            <div class="col-md-5">
                                <div class="input-group"><select name="region_id" id="region_id" class="custom-select form-control">
                                        ...
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ctn->id); ?>"><?php echo e($ctn->iso3); ?> || <?php echo e($ctn->nicename); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mPortal\resources\views/backend/video-audio/create.blade.php ENDPATH**/ ?>