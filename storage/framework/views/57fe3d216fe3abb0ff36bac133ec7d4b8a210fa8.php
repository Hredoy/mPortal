                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-xs-3 visible-xs">
                                                            <a href="<?php echo e(route('home')); ?>" class="btn-menu-toggle"><i
                                                                    class="cv cvicon-cv-menu"></i></a>
                                                        </div>
                                                        <div class="col-lg-1 col-sm-2 col-xs-6">
                                                            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                                                                <img src="<?php echo e($settings->logo); ?>"
                                                                    alt="<?php echo e($settings->app_name); ?>" class="logo" />
                                                        ...
                                                        <div class="col-lg-3 col-sm-10 hidden-xs">
                                                            <ul class="list-inline menu">
                                                                <li
                                                                    class="<?php echo e(Request::is('music') ? 'color-active' : null); ?>">
                                                                    <a href="<?php echo e(route('music')); ?>">Music</a>
                                                                </li>
                                                                <li
                                                                    class="<?php echo e(Request::is('comedy') ? 'color-active' : null); ?>">
                                                                    <a href="<?php echo e(route('comedy')); ?>">Comedy</a>
                                                                </li>
                                                                <li
                                                                    class="<?php echo e(Request::is('talent') ? 'color-active' : null); ?>">
                                                        ...
                                                        <div class="col-lg-6 col-sm-8 col-xs-3"
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group-btn">
                                                                            <div type="text" class="btn btn-default">
                                                                                <i
                                                                                    class="cv cvicon-cv-video-file"></i>&nbsp;&nbsp;&nbsp;
                                                                            </div>
                                                                        </div><!-- /btn-group -->
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div id="searchResultDiv"
                                                                style="position: absolute;z-index:1; width:95%">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2 col-sm-4 hidden-xs">
                                                            <div class="avatar pull-left">
                                                                <?php if(auth()->guard()->guest()): ?>
                                                                    <img src="<?php echo e(asset('assets/frontend/images/avatar.png')); ?>"
                                                                        alt="avatar" />
                                                                <?php endif; ?>
                                                                <?php if(auth()->guard()->check()): ?>
                                                                    <img src="<?php if(Auth::user()->profile && Auth::user()->profile->avatar_status == 1): ?> <?php echo e(Auth::user()->profile->avatar); ?> <?php else: ?> <?php echo e(Gravatar::get(Auth::user()->email)); ?> <?php endif; ?>"
                                                                        alt="<?php echo e(Auth::user()->name); ?>" height="44px"
                                                                        width="100%" class="user-logo" />
                                                                <?php endif; ?>
                                                            ...
                                                            <div class="selectuser pull-left">
                                                                <div class="btn-group pull-right dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <?php if(auth()->guard()->check()): ?>
                                                                            <li><a
                                                                                    href="<?php echo e(route('public.home')); ?>">Dashboard</a>
                                                                            </li>
