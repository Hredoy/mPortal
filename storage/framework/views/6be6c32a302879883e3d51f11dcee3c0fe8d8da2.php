        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li><a href="<?php echo e(url('/')); ?>" class="text-primary"><i class="ri-arrow-right-line"></i><span>Visit
                            site</span></a></li>
                <li class="active active-menu"><a href="<?php echo e(route('home')); ?>" class="iq-waves-effect"><i
...
<?php /**PATH C:\xampp\htdocs\projects\pro-4\mPortal\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>