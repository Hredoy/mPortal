                ...
                <div class="l-form">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="row visible-xs">
                            <div class="col-xs-6">
                                <div class="forgottext"><a href="<?php echo e(route('password.request')); ?>">Forgot Password?</a></div>
                            </div>
                            <div class="col-xs-6"><div class="signuptext text-right"><a href="<?php echo e(route('register')); ?>">Sign Up</a></div></div>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\2spiceart\resources\views/auth/login.blade.php ENDPATH**/ ?>