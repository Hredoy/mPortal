                        ...
                        <div class="form-group has-feedback row"><label for="role" class="col-md-3 control-label">Region</label>
                            <div class="col-md-5">
                                <div class="input-group"><select name="region_id" id="region_id" class="custom-select form-control">
                                        ...
                                        <option value="<?php echo e($ctn->id); ?>" <?php echo e($ctn->id == $video->region_id ? 'selected':''); ?>><?php echo e($ctn->iso3); ?> || <?php echo e($ctn->region_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\pro-4\mPortal\resources\views/backend/video-audio/edit.blade.php ENDPATH**/ ?>