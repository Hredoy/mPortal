                            ...
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/01.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                      ...
                      <li class="col-sm-6 col-lg-4 col-xl-3 iq-rated-box">
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/02.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                               <div class="iq-feature-list">
                      ...
                      <li class="col-sm-6 col-lg-4 col-xl-3 iq-rated-box">
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/03.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                               <div class="iq-feature-list">
                      ...
                      <li class="col-sm-6 col-lg-4 col-xl-3 iq-rated-box">
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/04.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                               <div class="iq-feature-list">
                      ...
                      <li class="col-sm-6 col-lg-4 col-xl-3 iq-rated-box">
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/05.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                               <div class="iq-feature-list">
                      ...
                      <li class="col-sm-6 col-lg-4 col-xl-3 iq-rated-box">
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               <div class="iq-thumb">
                                  <a href="javascript:void(0)">
                                     <img src="<?php echo e(asset('assets/backend/assets/images/dashboard/06.jpg')); ?>" class="img-fluid w-100 img-border-radius" alt="">
                                  </a>
                               </div>
                               <div class="iq-feature-list">
                         ...
                         <tbody>
                            <tr>
                               <td>
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="<?php echo e(asset('assets/backend/assets/images/movie-thumb/01.jpg')); ?>" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                            ...
                            <tr>
                               <td >
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="<?php echo e(asset('assets/backend/assets/images/show-thumb/05.jpg')); ?>" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                                     <div class="media-body text-white text-left ml-3">
                            ...
                            <tr>
                               <td>
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="<?php echo e(asset('assets/backend/assets/images/show-thumb/07.jpg')); ?>" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                                     <div class="media-body text-white text-left ml-3">
                            ...
                            <tr>
                               <td>
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="<?php echo e(asset('assets/backend/assets/images/show-thumb/10.jpg')); ?>" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                                     <div class="media-body text-white text-left ml-3">
                            ...
                            <tr>
                               <td>
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="<?php echo e(asset('assets/backend/assets/images/show-thumb/04.jpg')); ?>" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                                     <div class="media-body text-white text-left ml-3">
...
<?php echo $__env->make('backend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\pro-4\mPortal\resources\views/backend/home.blade.php ENDPATH**/ ?>